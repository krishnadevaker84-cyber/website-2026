...
const researchGazetteData = [
  {
    ...
    description:
      "Links to resumes of seniors who have successfully secured positions in leading firms.",
  ...
  },
  {
    ...
    description:
      "Resources for the students to prepare for internships and placements for various domains.",
