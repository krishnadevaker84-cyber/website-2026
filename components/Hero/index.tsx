        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <p>
                Welcome to the Academics and Career Council (AnC) — the central hub under the Students' Gymkhana dedicated to fulfilling the academic, research, and career aspirations of the student community. Beyond academics and placements, the AnC is deeply committed to proactive policy-making and student welfare, ensuring that every student's voice directly shapes the academic and professional ecosystem of our campus.
              </p>
