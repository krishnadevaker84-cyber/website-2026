            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              src="/images/logo/anc_logo2.png"
                ...
                <div className="space-y-8 mt-8 pb-4">
                  {/* UG Card */}
                  <div className="relative border border-stroke bg-white dark:border-strokedark dark:bg-black p-5 rounded-xl text-center shadow-solid-3 dark:shadow-none hover:shadow-solid-4 transition-all duration-300">
                    <span className="text-[10px] font-extrabold uppercase tracking-wider text-primary mb-1 block">
                      UG GenSec Office
                    </span>
                    <a href="mailto:ug_anc@iitk.ac.in" className="text-xs font-semibold text-black dark:text-white hover:text-primary transition-colors hover:underline block break-all mb-4">
                      ug_anc@iitk.ac.in
                    </a>
                    <Link
                      href="/team"
                      className="absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 flex items-center justify-center rounded-full bg-primary px-5 py-1.5 text-[10px] font-bold text-white shadow-solid-3 hover:bg-primaryho hover:scale-105 transition-all duration-300"
                    >
                      Details
                    </Link>
                  </div>
                  ...
                  <div className="relative border border-stroke bg-white dark:border-strokedark dark:bg-black p-5 rounded-xl text-center shadow-solid-3 dark:shadow-none hover:shadow-solid-4 transition-all duration-300">
                    ...
                    <a href="mailto:pg_anc@iitk.ac.in" className="text-xs font-semibold text-black dark:text-white hover:text-primary transition-colors hover:underline block break-all mb-4">
                      pg_anc@iitk.ac.in
                    </a>
                    <Link
                      href="/team"
