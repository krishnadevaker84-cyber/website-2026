...
const ActivityCard = ({ activity, index }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center p-6 bg-white dark:bg-gray-800 rounded-lg transition-transform transform hover:-translate-y-2 duration-300 shadow-solid-3 hover:shadow-solid-4"
    >
